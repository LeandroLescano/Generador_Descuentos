...
function ResultPage(props) {
  ...
  const guardarCambios = () => {
    ...
    for (let key in state.valuesMesAnterior) {
      ...
      if (state.valuesMesAnterior[key].diasdesc !== descuentosMonthPrevious[0].agentesAus[indexAgent].diasdesc
        && state.valuesMesAnterior[key].diasdesc !== undefined)
        descuentosMonthPrevious[0].agentesAus[indexAgent].diasdesc = state.valuesMesAnterior[key].diasdesc;

      if (state.valuesMesAnterior[key].diasexenfer !== descuentosMonthPrevious[0].agentesAus[indexAgent].diasexenfer
        && state.valuesMesAnterior[key].diasexenfer !== undefined)
        descuentosMonthPrevious[0].agentesAus[indexAgent].diasexenfer = state.valuesMesAnterior[key].diasexenfer;

      if (state.valuesMesAnterior[key].diasexenfamil !== descuentosMonthPrevious[0].agentesAus[indexAgent].diasexenfamil
       && state.valuesMesAnterior[key].diasexenfamil !== undefined)
        descuentosMonthPrevious[0].agentesAus[indexAgent].diasexenfamil = state.valuesMesAnterior[key].diasexenfamil;
    }
    setState(state => ({
      ...state,
...
{/*Check de omisiones de fichada y ausencias del mes pasado*/}
  const checkOmisionesF = () => {
    ...
    if (
      state.descuentos[0].agentesNov.filter((agent) => agent.diasdesc > 0).length >
        0 &&
  ...
  const toggleToast = () => {
    Swal.fire({
      ...
      position: "top",
      icon: "warning",
      title: "Las omisiones de fichada fueron automaticamente pasadas al archivo de ausencias",
      timer: 6000,
                ...
                <MDBCardBody className="text-center">
                  ...
                  <>
                    <div className="d-flex">
                      ...
                      {state.agentesAusMesAnterior.length > 0 && <MDBBtn className="btn-elegant ml-auto" onClick={() => toggleModal()}>Ausencias excedentes al mes actual</MDBBtn>}
                    </div>
                    ...
                    <CsvDownloader
                      ...
                      datas={state.descuentos[0].agentesAus
                        .filter((agent) => agent.diasdesc > 0)
                        .slice(1)}
                      columns={[{
                          id: "legajo",
                          displayName: state.descuentos[0].agentesAus[0].legajo,
                        },
                        {
                          id: "default",
                          displayName: state.descuentos[0].agentesAus[0].default,
                        },
                        {
                          id: "diasdesc",
                          displayName: state.descuentos[0].agentesAus[0].diasdesc,
                        }]}
                      >
                    ...
                    <CsvDownloader
                      ...
                      columns={[{
                          id: "legajo",
                          displayName: state.descuentos[0].agentesAus.filter(
                            agent => agent.diasexenfer > 0
                          )[0].legajo,
                        },
                        {
                    ...
                    <>
                      ...
                      {state.descuentos[0].agentesNov.filter(
                        ...
                        <CsvDownloader
                          ...
                          datas={state.descuentos[0].agentesNov
                            .filter((agent) => agent.horasdesc >= 0.5)
                            .slice(1)}
                          columns={[{
                              id: "legajo",
                              displayName: state.descuentos[0].agentesNov.filter(
                                (agent) => agent.horasdesc >= 0.5
                              )[0].legajo,
                            },
                            {
          ...
          <MDBModalBody>
            <MDBTable className="text-center" responsiveSm>
              ...
              <MDBTableBody>
                ...
                state.agentesAusMesAnterior.map(
                (item, i) => {
                  return (
                    <tr key={i}>
                      <td className="text-center">
                      ...
                      <td>{item.nombre}</td>
                      <td className="text-center">
                        <MDBInput className="text-center" name="diasdesc" onChange={ handleChange.bind(this, item.legajo)} valueDefault={item.diasdesc}/>
                      </td>
                      <td className="text-center">
                        <MDBInput className="text-center" name="diasexenfer" onChange={ handleChange.bind(this, item.legajo)} valueDefault={item.diasexenfer}/>
                      </td>
                      <td className="text-center">
                        <MDBInput className="text-center" name="diasexenfamil" onChange={ handleChange.bind(this, item.legajo)} valueDefault={item.diasexenfamil}/>
                      </td>
                    </tr>
                  );
                }
